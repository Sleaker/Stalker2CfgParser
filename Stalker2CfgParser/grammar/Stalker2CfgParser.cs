...
public partial class Stalker2CfgParser : Parser {
	...
	public CfgContext cfg() {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1122338L) != 0)) {
				{
				{
				State = 22;
				map();
	...
	public partial class ValueContext : ParserRuleContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode[] ARRAY_SEPARATOR() { return GetTokens(Stalker2CfgParser.ARRAY_SEPARATOR); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode ARRAY_SEPARATOR(int i) {
			return GetToken(Stalker2CfgParser.ARRAY_SEPARATOR, i);
		}
	...
	public partial class Set_refContext : ParserRuleContext {
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode OPEN_BRACE() { return GetToken(Stalker2CfgParser.OPEN_BRACE, 0); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode SET_INDEX() { return GetToken(Stalker2CfgParser.SET_INDEX, 0); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode CLOSE_BRACE() { return GetToken(Stalker2CfgParser.CLOSE_BRACE, 0); }
	...
	private static int[] _serializedATN = {
		...
		1,0,7,9,121,0,25,1,0,0,0,2,52,1,0,0,0,4,54,1,0,0,0,6,64,1,0,0,0,8,66,1,
		0,0,0,10,91,1,0,0,0,12,97,1,0,0,0,14,99,1,0,0,0,16,103,1,0,0,0,18,107,
		...
		0,0,0,30,31,3,12,6,0,31,35,5,3,0,0,32,34,3,8,4,0,33,32,1,0,0,0,34,37,1,
		0,0,0,35,33,1,0,0,0,35,36,1,0,0,0,36,38,1,0,0,0,37,35,1,0,0,0,38,43,5,
		16,0,0,39,42,3,4,2,0,40,42,3,2,1,0,41,39,1,0,0,0,41,40,1,0,0,0,42,45,1,
		0,0,0,43,41,1,0,0,0,43,44,1,0,0,0,44,46,1,0,0,0,45,43,1,0,0,0,46,48,5,
		4,0,0,47,49,5,16,0,0,48,47,1,0,0,0,48,49,1,0,0,0,49,53,1,0,0,0,50,53,5,
		1,0,0,51,53,5,16,0,0,52,30,1,0,0,0,52,50,1,0,0,0,52,51,1,0,0,0,53,3,1,
		0,0,0,54,55,3,12,6,0,55,57,5,6,0,0,56,58,3,10,5,0,57,56,1,0,0,0,57,58,
		1,0,0,0,58,60,1,0,0,0,59,61,5,16,0,0,60,59,1,0,0,0,60,61,1,0,0,0,61,5,
		1,0,0,0,62,65,3,4,2,0,63,65,5,17,0,0,64,62,1,0,0,0,64,63,1,0,0,0,65,7,
		...
		1,0,0,0,75,76,5,21,0,0,76,9,1,0,0,0,77,92,3,18,9,0,78,92,5,10,0,0,79,84,
		5,13,0,0,80,81,5,18,0,0,81,83,5,13,0,0,82,80,1,0,0,0,83,86,1,0,0,0,84,
		82,1,0,0,0,84,85,1,0,0,0,85,92,1,0,0,0,86,84,1,0,0,0,87,92,5,14,0,0,88,
		92,3,14,7,0,89,92,5,11,0,0,90,92,5,12,0,0,91,77,1,0,0,0,91,78,1,0,0,0,
		91,79,1,0,0,0,91,87,1,0,0,0,91,88,1,0,0,0,91,89,1,0,0,0,91,90,1,0,0,0,
		92,11,1,0,0,0,93,98,3,20,10,0,94,98,5,13,0,0,95,98,3,14,7,0,96,98,3,16,
		8,0,97,93,1,0,0,0,97,94,1,0,0,0,97,95,1,0,0,0,97,96,1,0,0,0,98,13,1,0,
		0,0,99,100,5,20,0,0,100,101,5,8,0,0,101,102,5,21,0,0,102,15,1,0,0,0,103,
		104,5,20,0,0,104,105,5,15,0,0,105,106,5,21,0,0,106,17,1,0,0,0,107,108,
		7,0,0,0,108,19,1,0,0,0,109,110,5,5,0,0,110,21,1,0,0,0,13,25,35,41,43,48,
